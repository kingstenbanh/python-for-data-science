...
def no_file():
    ...
    print('http://www.dtic.upf.edu/~ocelma/MusicRecommendationDataset/lastfm-360K.html (~543 MB)')
    print('then place it in the data folder and change the file_path')
...
def fetch_lastfm(min_plays = 200):
    ...
    # Read the file and file variables with data to
